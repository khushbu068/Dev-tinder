...
<div className="relative h-full overflow-hidden text-white">
      ...
      {/* Top Navbar */}
      <div className="absolute top-0 left-0 w-full flex justify-between items-center px-3 py-2 z-20 text-sm text-gray-200">
        <div className="font-semibold tracking-wider text-lg text-yellow-400">
          Dev-Tinder
        </div>
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full px-4 text-center">
        ...
        >
          Discover like-minded developers, start real conversations, and build
          amazing things together.
        </motion.p>

        <motion.button
          onClick={() => navigate("/login")}
          className="mt-8 px-4 py-1.5 bg-yellow-400 text-black font-bold rounded shadow-lg hover:bg-yellow-300 transition duration-300 hover:shadow-2xl"
