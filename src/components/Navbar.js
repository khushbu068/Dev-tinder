  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {menuOpen && (
          <ul className="absolute left-0 mt-2 w-48 bg-[#4F959D] text-white shadow-lg rounded-md overflow-hidden transition-transform duration-200">
            <li className="hover:bg-[#98D2C0] px-4 py-2 cursor-pointer" onClick={() => { navigate("/login"); setMenuOpen(false); }}>Home</li>
            <li className="hover:bg-[#98D2C0] px-4 py-2 cursor-pointer" onClick={() => { navigate("/myprofile"); setMenuOpen(false); }}>My Profile</li>
            <li className="hover:bg-red-500 px-4 py-2 cursor-pointer" onClick={handleLogout}>Logout</li>
            <li className="hover:bg-[#98D2C0] px-4 py-2 cursor-pointer" onClick={() => { navigate("/friends"); }}>Friends</li>
          </ul>
        )}
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <Link to="/connections" className="btn btn-outline">Connections</Link>
      </div>
    </motion.nav>
  );
};
