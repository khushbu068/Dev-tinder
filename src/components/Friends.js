      ...
      {friends.map((friend) => (
        ...
        >
          ...
          <div className="card-body">
            ...
            <p><strong>About:</strong> {friend.about || "No bio provided"}</p>

           <div className="card-actions flex gap-x-12 justify-end">
            <button className="btn btn-primary " onClick={() => handleProfileClick(friend._id)}>
              View Profile
            </button>
